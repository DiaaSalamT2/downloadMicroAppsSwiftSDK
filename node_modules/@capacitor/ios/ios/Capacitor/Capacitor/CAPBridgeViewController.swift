...
open class CAPBridgeViewController: UIViewController, CAPBridgeDelegate, WKScriptMessageHandler, WKUIDelegate, WKNavigationDelegate {
  ...
  private var handler: CAPAssetHandler?
    ...
    open func getStartPath() -> String? {
    var resourcesPath = assetsFolder
      var startPath = assetsFolder
    if !startDir.isEmpty {
...
//    }
  ...
  func loadWebView() {
    let fullStartPath = URL(fileURLWithPath: assetsFolder).appendingPathComponent(startDir).appendingPathComponent("index.html")
